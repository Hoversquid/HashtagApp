<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerPageNew.aspx.cs" Inherits="QuoteLogin.CustomerPage" EnableEventValidation="false" %>
...
<body>
    <form id="CustForm" class="MainForm" runat="server">
        ...
        <asp:Panel ID="SearchResults" CssClass="SearchResultsClass" runat="server" HorizontalAlign="Center" Direction="LeftToRight">
            <asp:Table runat="server" HorizontalAlign="Center" Height="100px">
                <asp:TableRow HorizontalAlign="Center">
                    <asp:TableCell Height="30px" Width="350px">
                        <asp:Label runat="server" Text="Customer search results: "/>

                    </asp:TableCell><asp:TableCell Width="350px">
                        <asp:Label runat="server" Text="Selected Customer:" />

                    </asp:TableCell>
                </asp:TableRow>
                <asp:TableRow>
                    <asp:TableCell VerticalAlign="Top" Height="200px">
                        <asp:GridView ID="CustGridView" OnRowDataBound="CustGridView_RowDataBound" OnSelectedIndexChanged="CustGridView_SelectedIndexChanged" runat="server" AutoGenerateColumns="False" DataKeyNames="CustID" DataSourceID="CustData" CellPadding="4" ForeColor="#333333" GridLines="None" TabIndex="10" AllowPaging="True" PageSize="5" Width="296px" HorizontalAlign="Center">
                    ...
                    <asp:TableCell HorizontalAlign="Center" VerticalAlign="Top">
                        <asp:DetailsView ID="SelectedCustDetailsView" runat="server" AutoGenerateRows="False" CellPadding="4" DataKeyNames="CustID" DataSourceID="SelectedCustData" ForeColor="#333333" GridLines="None" BorderStyle="Solid" Height="197px" Width="284px" HorizontalAlign="Center">
                            <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
        ...
        <asp:Panel ID="CreateCustPanel" runat="server">
            <asp:Table CssClass="TableForm" runat="server" CellPadding="5" HorizontalAlign="Center">
                ...
                <asp:TableRow>
                    <asp:TableCell>
                        ...
                        <asp:TextBox ID="CustNotesText" CssClass="TableFormInput" TextMode="MultiLine" MaxLength="250" runat="server" Height="60px" />
                    </asp:TableCell>
                </asp:TableRow>
            </asp:Table>
            ...
            <asp:DetailsView ID="EditCustomerDetailsView" runat="server" AutoGenerateRows="False" CellPadding="4" DataKeyNames="CustID" DataSourceID="SelectedCustData" ForeColor="#333333" GridLines="None" BorderStyle="Solid" Height="197px" Width="284px" HorizontalAlign="Center" DefaultMode="Edit">
                ...
                <Fields>
                    ...
                    <asp:TemplateField HeaderText="Notes" SortExpression="Notes">
                        <EditItemTemplate>
                            <asp:TextBox ID="NotesBinding" runat="server" Text='<%# Bind("Notes") %>' TextMode="MultiLine" MaxLength="250" />
        ...
        <asp:Panel ID="StartQuotePanel" runat="server" Visible="false" HorizontalAlign="Center">
        ...
        <asp:Panel ID="CustSelectedActionPanel" CssClass="PageAction" runat="server">
        ...
        <asp:SqlDataSource ID="CustData" runat="server"
        ...
        <asp:SqlDataSource ID="AllCustData" runat="server" ConnectionString="<%$ ConnectionStrings:QuoteDBConnection %>" SelectCommand="SELECT * FROM [Customer]" />
    </form>
</body>
</html>
