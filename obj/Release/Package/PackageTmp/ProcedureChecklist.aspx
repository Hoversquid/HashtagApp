...
<asp:Content ID="MainProcedureChecklist" ContentPlaceHolderID="Main" runat="server">
    ...
    <asp:Panel ID="OpeningEmailPanel" runat="server" Visible="false">
        <asp:Table HorizontalAlign="Center" runat="server" CellPadding="5" CellSpacing="5">
            <asp:TableRow>
                <asp:TableCell>
                    <asp:Button ID="OpeningEmailButton" Width="120px" Text="Email" runat="server" OnClick="OpeningEmailButton_Click" />
                </asp:TableCell><asp:TableCell>
                    <asp:Button ID="OpeningBackButton" Width="120px" Text="Back" runat="server" OnClick="OpeningBackButton_Click" />
                </asp:TableCell>
            </asp:TableRow>
        </asp:Table>
    </asp:Panel>
    <asp:Panel ID="ClosingEmailPanel" runat="server" Visible="false">
        <asp:Table HorizontalAlign="Center" runat="server" CellPadding="5" CellSpacing="5">
            <asp:TableRow>
                <asp:TableCell>
                    <asp:Button ID="ClosingEmailButton" Width="120px" Text="Email" runat="server" OnClick="ClosingEmailButton_Click" />
                </asp:TableCell><asp:TableCell>
                    <asp:Button ID="ClosingBackButton" Width="120px" Text="Back" runat="server" OnClick="ClosingBackButton_Click" />
                </asp:TableCell>
            </asp:TableRow>
        </asp:Table>
    </asp:Panel>
    <asp:Table ID="SelectionTable" HorizontalAlign="Center" runat="server">
        ...
        <asp:TableRow>
            ...
            </asp:TableCell></asp:TableRow></asp:Table><div id="CanvasDiv" />
    <div class="PrintDiv">
    ...
    <asp:Panel ID="OpeningProcedurePanel" runat="server" Visible="false">
        <div class="PrintDiv">
            <asp:Table runat="server" CssClass="PanelLabelHeader">
                <asp:TableRow>
                    <asp:TableCell HorizontalAlign="Right">Opening Person #1 : </asp:TableCell><asp:TableCell HorizontalAlign="Right"><asp:TextBox CssClass="AmountInputText" runat="server" /></asp:TableCell><asp:TableCell HorizontalAlign="Right">Opening Person #2 : </asp:TableCell><asp:TableCell HorizontalAlign="Right"><asp:TextBox CssClass="AmountInputText" runat="server" /></asp:TableCell></asp:TableRow></asp:Table><asp:UpdatePanel runat="server">
                <ContentTemplate>
                    <div style="clear: both;">
                        <div class="LeftColumnGridDiv">
                            ...
                            $$ Total
                                ...
                                $100 bill:
                                        ...
                                        <asp:TableRow>
                                            ...
                                            </asp:TableCell></asp:TableRow></asp:Table><asp:Button ID="CalcOpeningButton" CausesValidation="true" runat="server" Text="Calculate" CssClass="CalcButton" OnClick="CalcOpeningButton_Click" />
                                </div>
                            </div>
                            ...
                            Pre-Opening incidents and/or comments
                                    ...
                                    <asp:TableCell>
                            <asp:TextBox runat="server" TextMode="MultiLine" Width="80%" Height="140px" />
                                    </asp:TableCell></asp:TableRow></asp:Table></div></div></ContentTemplate></asp:UpdatePanel><div class="RightColumnGridDiv">
                <asp:Table CssClass="CheckboxTable" runat="server" CellPadding="5" CellSpacing="0" Height="420px">
                    <asp:TableRow>
                        <asp:TableCell>Make sure cash drawer is counted before opening store:</asp:TableCell><asp:TableCell><asp:CheckBox ValidationGroup="Checkbox" runat="server" /></asp:TableCell>
                    </asp:TableRow>
                    <asp:TableRow>
                        <asp:TableCell>Make sure due today,due tommorrow,past due email are sent before store open</asp:TableCell><asp:TableCell><asp:CheckBox ValidationGroup="Checkbox" runat="server" /></asp:TableCell>
                    </asp:TableRow>
                    <asp:TableRow>
                        <asp:TableCell>Review previous night EOD paperwork to ensure it is filed correctly.</asp:TableCell><asp:TableCell><asp:CheckBox ValidationGroup="Checkbox" runat="server" /></asp:TableCell>
                    </asp:TableRow>
                    <asp:TableRow>
                        <asp:TableCell>Notify manager if cash drawers is less than 100 and if not counted before store opens</asp:TableCell><asp:TableCell><asp:CheckBox ValidationGroup="Checkbox" runat="server" /></asp:TableCell>
                    </asp:TableRow>
                    <asp:TableRow>
                        <asp:TableCell>Make sure store is clean and ready for business,</asp:TableCell><asp:TableCell><asp:CheckBox ValidationGroup="Checkbox" runat="server" /></asp:TableCell>
                    </asp:TableRow>
                    <asp:TableRow>
                        <asp:TableCell>Turn on open sign at 10am/ unlock door/Turn on music</asp:TableCell><asp:TableCell><asp:CheckBox ValidationGroup="Checkbox" runat="server" /></asp:TableCell>
                    </asp:TableRow>
                    <asp:TableRow>
                        <asp:TableCell>Verify Price strips/fact tags are in place/correct for all displayed </asp:TableCell><asp:TableCell><asp:CheckBox ValidationGroup="Checkbox" runat="server" /></asp:TableCell>
                    </asp:TableRow>
                    <asp:TableRow>
                        <asp:TableCell Font-Bold="true">Turn off outside sign at breaker:</asp:TableCell><asp:TableCell><asp:CheckBox ValidationGroup="Checkbox" runat="server" /></asp:TableCell>
                    </asp:TableRow>
                    <asp:TableRow>
                        <asp:TableCell>Ensure all area's front and back are clear of any proprietary info</asp:TableCell><asp:TableCell><asp:CheckBox ValidationGroup="Checkbox" runat="server" /></asp:TableCell>
                    </asp:TableRow>
                    <asp:TableRow>
                        <asp:TableCell>Review previous day EOD paperwork and file away</asp:TableCell><asp:TableCell><asp:CheckBox ValidationGroup="Checkbox" runat="server" /></asp:TableCell>
                    </asp:TableRow>
                    <asp:TableRow>
                        <asp:TableCell>Review/set store and individual goals / Update Sales Boards:</asp:TableCell><asp:TableCell><asp:CheckBox ValidationGroup="Checkbox" runat="server" /></asp:TableCell>
                    </asp:TableRow>
                </asp:Table>
            </div>
            <div style="clear: both;" />
    ...
    <asp:Panel ID="ClosingProcedurePanel" runat="server" Visible="false">
        <div class="PrintDiv">
            <asp:Table runat="server" CssClass="PanelLabelHeader">
                <asp:TableRow>
                    <asp:TableCell HorizontalAlign="Right">Closing Person #1 : </asp:TableCell><asp:TableCell HorizontalAlign="Right"><asp:TextBox CssClass="AmountInputText" runat="server" /></asp:TableCell><asp:TableCell HorizontalAlign="Right">Closing Person #2 : </asp:TableCell><asp:TableCell HorizontalAlign="Right"><asp:TextBox CssClass="AmountInputText" runat="server" /></asp:TableCell></asp:TableRow></asp:Table><asp:UpdatePanel runat="server">
                <ContentTemplate>
                    <div class="LeftColumnGridDiv">
                        <div style="clear: both;">
                            <div class="LeftColumnGridDiv">
                            ...
                            $$ Total
                                ...
                                $100 bill:
                                    ...
                                    <asp:TableRow>
                                        ...
                                        </asp:TableCell></asp:TableRow></asp:Table><asp:Button ID="CalcClosingButton" CausesValidation="true" runat="server" Text="Calculate" CssClass="CalcButton" OnClick="CalcClosingButton_Click" />
                ...
                <asp:Table CssClass="CheckboxTable" runat="server" CellPadding="5" CellSpacing="0" Height="420px">
                    <asp:TableRow>
                        <asp:TableCell>File invoices/service request/Part order on order form</asp:TableCell><asp:TableCell><asp:CheckBox ValidationGroup="Checkbox" runat="server" /></asp:TableCell>
                    </asp:TableRow>
                    <asp:TableRow>
                        <asp:TableCell>Verify Price strips/fact tags are in place/correct for all displayed</asp:TableCell><asp:TableCell><asp:CheckBox ValidationGroup="Checkbox" runat="server" /></asp:TableCell>
                    </asp:TableRow>
                    <asp:TableRow>
                        <asp:TableCell Font-Bold="true">Turn on outside sign at breaker</asp:TableCell><asp:TableCell><asp:CheckBox ValidationGroup="Checkbox" runat="server" /></asp:TableCell>
                    </asp:TableRow>
                    <asp:TableRow>
                        <asp:TableCell>Ensure all area's front and back are clear of any proprietary info</asp:TableCell><asp:TableCell><asp:CheckBox ValidationGroup="Checkbox" runat="server" /></asp:TableCell>
                    </asp:TableRow>
                    <asp:TableRow>
                        <asp:TableCell>How many repairs was completed/pre-own & accessory sold</asp:TableCell><asp:TableCell><asp:CheckBox ValidationGroup="Checkbox" runat="server" /></asp:TableCell>
                    </asp:TableRow>
                    <asp:TableRow>
                        <asp:TableCell>Make sure all notes have been put on accounts</asp:TableCell><asp:TableCell><asp:CheckBox ValidationGroup="Checkbox" runat="server" /></asp:TableCell>
                    </asp:TableRow>
                    <asp:TableRow>
                        <asp:TableCell>Clear all customer info from itunes and any other drives </asp:TableCell><asp:TableCell><asp:CheckBox ValidationGroup="Checkbox" runat="server" /></asp:TableCell>
                    </asp:TableRow>
                    <asp:TableRow>
                        <asp:TableCell>Sweep, mop, take out trash, clean glass and all other area's nessasary</asp:TableCell><asp:TableCell><asp:CheckBox ValidationGroup="Checkbox" runat="server" /></asp:TableCell>
                    </asp:TableRow>
                    <asp:TableRow>
                        <asp:TableCell>Charge store phone and any other devices on display</asp:TableCell><asp:TableCell><asp:CheckBox ValidationGroup="Checkbox" runat="server" /></asp:TableCell>
                    </asp:TableRow>
                    <asp:TableRow>
                        <asp:TableCell>File or shred paperwork ensure notes are on accounts</asp:TableCell><asp:TableCell><asp:CheckBox ValidationGroup="Checkbox" runat="server" /></asp:TableCell>
                    </asp:TableRow>
                    <asp:TableRow>
                        <asp:TableCell>Ensure panels are locked / Run batch out</asp:TableCell><asp:TableCell><asp:CheckBox ValidationGroup="Checkbox" runat="server" /></asp:TableCell>
                    </asp:TableRow>
                    <asp:TableRow>
                        <asp:TableCell>Ensure deposit is correct and verified by both closers/signed/dropped</asp:TableCell><asp:TableCell><asp:CheckBox ValidationGroup="Checkbox" runat="server" /></asp:TableCell>
                    </asp:TableRow>
                    <asp:TableRow>
                        <asp:TableCell>Email Mr. Charlie EOB info and order form / set alarm</asp:TableCell><asp:TableCell><asp:CheckBox ValidationGroup="Checkbox" runat="server" /></asp:TableCell>
                    </asp:TableRow>
                    <asp:TableRow>
                        <asp:TableCell>Bank deposit slips have 2 full signatures</asp:TableCell><asp:TableCell><asp:CheckBox ValidationGroup="Checkbox" runat="server" /></asp:TableCell>
                    </asp:TableRow>
                    <asp:TableRow>
                        <asp:TableCell>Deposit bag sealed before placing in drop safe</asp:TableCell><asp:TableCell><asp:CheckBox ValidationGroup="Checkbox" runat="server" /></asp:TableCell>
                    </asp:TableRow>
                </asp:Table>
            </div>
            <div style="clear: both;" />
                ...
                <ContentTemplate>
                    ...
                    Pre-own Sold
                        ...
                        Total AIMSI Deposit:
                                ...
                                </asp:TableCell></asp:TableRow></asp:Table><asp:Table runat="server" CssClass="IncidentsTable">
                            <asp:TableRow>
                                <asp:TableCell Font-Bold="true">
                            Comments
                                </asp:TableCell></asp:TableRow><asp:TableRow>
                    ...
                    Daily Avg Ticket
                                </asp:TableCell><asp:TableCell Font-Size="Small">Returns</asp:TableCell></asp:TableRow><asp:TableRow>
                        ...
                        Total Daily Amount:
                                ...
                                </asp:TableCell></asp:TableRow></asp:Table><asp:Button ID="CalcDepositButton" CssClass="CalcButton" CausesValidation="true" OnClick="CalcDepositButton_Click" Text="Calculate" runat="server" />
                    </div>
    ...
    <asp:Panel ID="OpeningSubmissionPanel" runat="server" Visible="false">
        <asp:Table CellPadding="5" CellSpacing="5" HorizontalAlign="Center" runat="server">
            <asp:TableRow>
                <asp:TableCell>
                    <asp:Button ID="SubmitOpeningButton" CausesValidation="true" runat="server" Text="Submit" Width="120px" OnClick="SubmitOpeningButton_Click" />
                </asp:TableCell><asp:TableCell>
                    <asp:Button ID="SubmitOpeningBackButton" Width="120px" Text="Back" runat="server" CausesValidation="false" OnClick="SubmitOpeningBackButton_Click" /></asp:TableCell>
            </asp:TableRow>
        </asp:Table>
    </asp:Panel>
    <asp:Panel ID="ClosingSubmissionPanel" Visible="false" runat="server">
        <asp:Table CellPadding="5" CellSpacing="5" HorizontalAlign="Center" runat="server">
            <asp:TableRow>
                <asp:TableCell>
                    <asp:Button ID="SubmitClosingButton" CausesValidation="true" runat="server" Text="Submit" Width="120px" OnClick="SubmitClosingButton_Click" />
                </asp:TableCell><asp:TableCell>
                    <asp:Button ID="SubmitClosingBackButton" Width="120px" Text="Back" runat="server" OnClick="SubmitClosingBackButton_Click" />
                </asp:TableCell></asp:TableRow></asp:Table></asp:Panel><asp:Panel ID="PageActionPanel" runat="server">
        <asp:Button ID="PageBackButton" runat="server" Text="Back" OnClick="PageBackButton_Click" CausesValidation="false" />
    </asp:Panel>
</asp:Content>
