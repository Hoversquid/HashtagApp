...
<body>
    <form id="quoteform" runat="server" method="post">
        <div class="MainForm">
            ...
            <asp:RegularExpressionValidator ID="PriceValidator" runat="server" ControlToValidate="PriceIn" Display="None" ValidationExpression="^\d+(\.\d\d)?$" CssClass="RequiredError" ErrorMessage="Enter valid price." />
            <asp:RequiredFieldValidator ID="PriceRequiredValidator" runat="server" ControlToValidate="PriceIn" Display="None" CssClass="RequiredError" ErrorMessage="Enter price." />
            <asp:CompareValidator runat="server" ControlToValidate="PriceIn" ValueToCompare="0" Type="Double" Operator="GreaterThan" Display="None" ErrorMessage="Enter price above 0." />
            <div class="LabelDiv">
                ...
                <asp:Table CssClass="TableForm" runat="server" HorizontalAlign="Center">
                    ...
                    <asp:TableRow>
                        <asp:TableCell>
                            ...
                            <asp:TextBox CssClass="inputbox" ID="IssueTextBox" MaxLength="250" runat="server" TextMode="MultiLine" Height="80px" />
                        </asp:TableCell>
                    </asp:TableRow>
                </asp:Table>
            </div>
