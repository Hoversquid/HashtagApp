<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ServiceRequestPage.aspx.cs" Inherits="QuoteLogin.ServiceRequestPage" EnableEventValidation="false" %>
    ...
    <script type="text/javascript">
        function PrintPanel() {
            if (Page_ClientValidate("")) {
                ...
                printWindow.document.write(document.getElementById('InitialDiv').innerHTML);
                printWindow.document.write(document.getElementById('ServiceRequestDiv').innerHTML);
                printWindow.document.write(document.getElementById('CustomerInitialDiv').innerHTML);
...
<body style="background-color: #ffffff; max-width: 1000px; margin: auto;">
                    ...
                    <asp:Panel ID="NewCustomerPanel" runat="server">
                        <asp:Table CssClass="ServiceRequestTable" runat="server" HorizontalAlign="Center">
                            <asp:TableRow>
                                ...
                                </asp:TableCell></asp:TableRow></asp:Table></asp:Panel><asp:Panel ID="MainServicePanel" runat="server">
                        <asp:Table CssClass="ServiceRequestTable" runat="server">
                            <asp:TableRow>
                                <asp:TableCell Width="33%">
                                ...
                                </asp:TableCell></asp:TableRow></asp:Table><asp:Table runat="server" CssClass="ServiceRequestTable">
                            <asp:TableRow>
                                ...
                                </asp:TableCell></asp:TableRow></asp:Table><asp:Table CssClass="ServiceRequestTable" runat="server">
                            <asp:TableRow>
                                ...
                                </asp:TableCell></asp:TableRow></asp:Table></asp:Panel></div><asp:Panel ID="ServiceTypePanel" runat="server">
                        <asp:Table CssClass="ServiceRequestStyleTable" runat="server">
                            <asp:TableRow>
                                ...
                                </asp:TableCell></asp:TableRow></asp:Table><asp:SqlDataSource runat="server" ID="ServReqTypesDataSource" ConnectionString='<%$ ConnectionStrings:QuoteDBConnection %>' SelectCommand="SELECT [Name] FROM [Service_Request_Type]" />
                    </asp:Panel>
                    ...
                    <asp:Panel ID="PhoneServiceRequestPanel" runat="server" Visible="false">
                        ...
                        <asp:Table runat="server" CssClass="ServiceRequestTable">
                            <asp:TableRow>
                                ...
                                <asp:TableCell HorizontalAlign="Right">
                                    <asp:Label runat="server" Text="____________________________" />
                                </asp:TableCell></asp:TableRow></asp:Table></asp:Panel><asp:Panel ID="ComputerServiceRequestPanel" runat="server" Visible="false">
                        <hr />
                        <asp:Table runat="server" CssClass="ServiceRequestTable">
                            <asp:TableRow>
                                <asp:TableCell Width="175px" Font-Size="Smaller" Font-Bold="True">
                                ...
                                <asp:TableCell HorizontalAlign="Right">
                                    <asp:Label runat="server" Text="____________________________" />
                                </asp:TableCell></asp:TableRow></asp:Table></asp:Panel><asp:Panel ID="TVServiceRequestPanel" runat="server" Visible="false">
                        <hr />
                        <asp:Table runat="server" CssClass="ServiceRequestTable">
                            <asp:TableRow>
                                <asp:TableCell Width="175px" Font-Size="Smaller" Font-Bold="True">
                                ...
                                <asp:TableCell HorizontalAlign="Right">
                                    <asp:Label runat="server" Text="____________________________" />
                                </asp:TableCell></asp:TableRow></asp:Table></asp:Panel><asp:Panel ID="TabletServiceRequestPanel" runat="server" Visible="false">
                        <hr />
                        <asp:Table runat="server" CssClass="ServiceRequestTable">
                            <asp:TableRow>
                                <asp:TableCell Width="175px" Font-Size="Smaller" Font-Bold="True">
                                ...
                                <asp:TableCell HorizontalAlign="Right">
                                    <asp:Label runat="server" Text="____________________________" />
                                </asp:TableCell></asp:TableRow></asp:Table></asp:Panel><asp:Panel ID="MacServiceRequestPanel" runat="server" Visible="false">
                        <hr />
                        <asp:Table runat="server" CssClass="ServiceRequestTable">
                            <asp:TableRow>
                                <asp:TableCell Width="175px" Font-Size="Smaller" Font-Bold="True">
                                ...
                                <asp:TableCell HorizontalAlign="Right">
                                    <asp:Label runat="server" Text="____________________________" />
                                </asp:TableCell></asp:TableRow></asp:Table></asp:Panel></div><div id="CustomerInitialDiv">
                    <div style="page-break-before: always; page-break-inside: avoid; position: relative; overflow-x: visible;">
                        <asp:Panel ID="CustomerInitialPanel" runat="server" Visible="false">
                            <asp:Table CssClass="ServiceRequestCustomerStyleTable" Height="50px" runat="server"><asp:TableRow>
                                    <asp:TableCell Width="500px" HorizontalAlign="Justify">
                                        Would you like to authorize anyone other than yourself to pick up your device?
                                    </asp:TableCell><asp:TableCell Width="120px" Font-Bold="true" Font-Underline="true" HorizontalAlign="Right">
                                        YES
                                    </asp:TableCell><asp:TableCell Width="120px" Font-Bold="true" Font-Underline="true" HorizontalAlign="Right">
                                        NO
                                    </asp:TableCell><asp:TableCell Width="300px" Font-Size="Small" HorizontalAlign="Right">
                                        If YES please provide name:  
                                    </asp:TableCell><asp:TableCell HorizontalAlign="Right">
                                        ________________
                                    </asp:TableCell></asp:TableRow></asp:Table>
                            <asp:Table CssClass="ServiceRequestCustomerStyleTable" Height="50px" runat="server">
                                <asp:TableRow>
                                    <asp:TableCell Width="500px" HorizontalAlign="Justify">
                                        Is it OK to contact you after 5:30PM during the week and on Saturday?
                                    </asp:TableCell><asp:TableCell Width="120px" Font-Bold="true" Font-Underline="true" HorizontalAlign="Right">
                                        YES
                                    </asp:TableCell><asp:TableCell Width="120px" Font-Bold="true" Font-Underline="true" HorizontalAlign="Right">
                                        NO
                                        ...
                                        ________________
                                    </asp:TableCell></asp:TableRow></asp:Table><asp:Table CssClass="ServiceRequestCustomerStyleTable" runat="server" Height="85px"><asp:TableRow>
                                    <asp:TableCell Width="750px" HorizontalAlign="Justify">
                                        By initialing here, you understand and agree that anything that doesn't work or can't be verified Hashtag iFix it LLC cannot and will not be held responsible for. 
                                    </asp:TableCell><asp:TableCell Width="300px" Font-Size="Small" HorizontalAlign="Right">
                                        Customer Initial Here: 
                                    </asp:TableCell><asp:TableCell HorizontalAlign="Right">
                                            ________________
                                    </asp:TableCell></asp:TableRow></asp:Table><asp:Table CssClass="ServiceRequestCustomerStyleTable" runat="server" Height="112px"><asp:TableRow>
                                    <asp:TableCell Width="750px" HorizontalAlign="Justify">
                                        ...
                                        ________________
                                    </asp:TableCell></asp:TableRow></asp:Table><hr /><asp:Table runat="server" CssClass="ServiceRequestCustomerStyleTable">
                                <asp:TableRow>
                                ...
                                <asp:Label runat="server" Text="Device Release Acknowledgement:" />
                                 ...
                                 <asp:Label runat="server" Text="I hereby acknowledge that I am the rightful owner or the authorized individual by the owner of this device. I acknowledge all functionality of this device is in working order as when it was initiallly brought in (with the addition of the repair.)" />
                                    </asp:TableCell></asp:TableRow></asp:Table><asp:Table runat="server" CssClass="ServiceRequestStyleTable">
                                <asp:TableRow>
                                ...
                                <asp:Label runat="server" Text="Date:____________________________" />
                                    </asp:TableCell></asp:TableRow></asp:Table></asp:Panel></div>
                </div>
                <asp:Panel runat="server" ID="SubmitButtonPanel" Visible="false">
                    <asp:Table runat="server" ID="Table1" CellPadding="30" HorizontalAlign="Center" Height="100px"><asp:TableRow>
                            <asp:TableCell>
                                <asp:Button ID="CreateServiceRequestButton" CausesValidation="true" runat="server" OnClick="CreateServiceRequestButton_Click" Text="Create Service Request" />
                            ...
                            </asp:TableCell></asp:TableRow></asp:Table><asp:Table runat="server" CssClass="PageAction" ID="Table2" CellPadding="20" HorizontalAlign="Center">
                ...
                <asp:Panel runat="server" ID="PageActionPanel">
                    <asp:Table runat="server" CssClass="PageAction" ID="PageActionTable" CellPadding="20" HorizontalAlign="Center">
                        <asp:TableRow>
                            ...
                            </asp:TableCell></asp:TableRow></asp:Table></asp:Panel></div></div></form></body></html>