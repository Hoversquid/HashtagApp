...
<body>
    <form id="LoginEditForm" runat="server">
        ...
        <div class="MainForm">
            <div class="LabelDiv">
                <asp:GridView ID="LoginGridView" CssClass="GridViewClass" runat="server" AutoGenerateColumns="False" DataSourceID="LoginViewDataSource" CellPadding="4" ForeColor="#333333" GridLines="None" AllowSorting="True" DataKeyNames="UserID" OnSelectedIndexChanging="LoginGridView_SelectedIndexChanging" OnRowDataBound="LoginGridView_RowDataBound" OnSelectedIndexChanged="LoginGridView_SelectedIndexChanged">
